...
def main() -> int:
    parser = argparse.ArgumentParser(description="Migra los CSV actuales a una base local SQLite.")
    parser.add_argument(
        "--append",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="Ruta del archivo SQLite. Por defecto: data/reporte_canvas.db",
    )
    ...
    print(f"Base de datos generada/actualizada: {db_path}")
